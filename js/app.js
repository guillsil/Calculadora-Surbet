...
function calculate() {
    ...
    document.getElementById("betting").innerHTML = "Deberías Apostar $" + howMuchbet_2.toLocaleString('es-ES', {minimumFractionDigits: 2}) + " a la Apuesta 1 y $" + howMuchbet1.toLocaleString('es-ES', {minimumFractionDigits: 2}) +
        " a la apuesta 2. El beneficio que puedes obtener es $" + winning.toLocaleString('es-ES', {minimumFractionDigits: 2}) + " con un porcentaje de ganancia del " + profitPercentage.toLocaleString('es-ES', {minimumFractionDigits: 2}) + "%.";
}
